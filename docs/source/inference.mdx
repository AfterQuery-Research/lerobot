...
See [Remote Policy Inference](./remote_inference) for server setup, authentication,
TLS or SSH tunneling, dual-YAM hardware configuration, and simulator testing.
